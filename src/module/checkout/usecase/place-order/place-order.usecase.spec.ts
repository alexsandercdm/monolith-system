...
describe("PlaceOrderUseCase unit test", () => {
    ...
    describe("Execute method", () => {
        ...
        it("should throw an error when client not found", async () => {
            ...
            //@ts-expect-error - no params in constructor
            const placeOrederUseCase = new PlaceOrderUseCase();
            //@ts-expect-error - force set clientFacade
            placeOrederUseCase["_clientFacade"] = mockCLientFacade;
            ...
            await expect(placeOrederUseCase.execute(input)).rejects.toThrow(
                new Error("Client not found")
            );
        });

        it("should throw an error when product are note valid", async () => {
            const mockCLientFacade = {
            ...
            const mockValidateProducts = jest
                ...
                .spyOn(placeOrederUseCase, "validateProducts")
        ...
        describe("place an order", () => {
            ...
            it("should not be approved", async () => {
                ...
                expect(mockCLientFacade.findClient).toHaveBeenCalledWith({ clientId: "1c" });
                expect(mockValidateProducts).toHaveBeenCalledTimes(1);
            ...
            it("should be approved", async () => {
                ...
                expect(mockInvoiceFacade.generate).toHaveBeenCalledWith({
                    ...
                    items: [{
                        ...
                        price: products["1"].salesPrices,
                    }, {
                        id: products["2"].id.id,
                        name: products["2"].name,
                        price: products["2"].salesPrices,
                    }],
                });
            });
        });
